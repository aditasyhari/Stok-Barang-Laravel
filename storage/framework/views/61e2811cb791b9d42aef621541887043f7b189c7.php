...
<div class="content">
    ...
    <form class="form-inline my-2 my-lg-3" action="/keuangan/data_pembeli/search" method="GET">
      <input class="form-control mr-sm-2" type="text" name="search" placeholder="Cari Nama Pembeli" aria-label="Search" value="<?php echo e(old('search')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\stok_barang_laravel-main\resources\views//keuangan/data_pembeli.blade.php ENDPATH**/ ?>