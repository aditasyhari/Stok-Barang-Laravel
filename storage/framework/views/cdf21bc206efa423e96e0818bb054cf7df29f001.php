            ...
            var markup = 
                `<tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger btn-sm del"><i class="icon-trash menu-icon"></i></button>
                    </td>
                </tr>`;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aditasyhari/Project Laravel/stok_barang_laravel-main/resources/views/kasir/kasir.blade.php ENDPATH**/ ?>