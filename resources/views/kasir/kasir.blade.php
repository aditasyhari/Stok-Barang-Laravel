                            ...
                            <div>
                                <select id="pembeli_id" class="js-example-basic-single form-control" name="pembeli_id" required>
                                    ...
                                    @foreach($data_pembelis as $pembeli)
                                        {{$loop->iteration}}
                                        <option value="{{$pembeli->id}}">{{$pembeli->kode_pembeli}} - {{$pembeli->nama_pembeli}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group input-group">
                                ...
                                <select class="js-example-basic-single form-control" onchange="cekStok()" name="barang" id="barang">
                                    ...
                                    <option value="['{{ $b->id }}', '{{ $b->kode_barang }}', '{{ $b->nama_barang }}', '{{ $b->harga_jual }}', '{{ $b->jumlah_barang }}']">{{ $b->kode_barang }} - {{ $b->nama_barang }} - {{ $b->jumlah_barang }}</option>
                                    @endforeach
                                </select>
